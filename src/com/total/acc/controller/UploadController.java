...
public class UploadController {
	...
	public @ResponseBody List<UploadFile> upload(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
...
//		String uploadFolder = "D://DATA/UPLOADFILE";
		...
		try {
			if (file.getSize() > 0) { 
				...
				UploadFile u = new UploadFile(0, file.getOriginalFilename(), Long.valueOf(file.getSize()).intValue(), DateTime.yyyy() + "/" + DateTime.mm() + "/" + DateTime.dd() + "/" + filename);
				uploadedFiles.add(u);
