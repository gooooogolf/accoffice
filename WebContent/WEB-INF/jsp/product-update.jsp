	                            	...
	                            	<div class="col-lg-6">
	                                        <div class="form-group">
											    ...
											    <div id="files" class="files">
											    	<img id="imgSrc" class="img-responsive" src="">
											    	<input type="hidden" id="fileId" value="${product.imgSrc }">
											    </div>
											    <br>
	                                        </div>	
...
function getImage(id) {
	$.ajax({
	    ...
	    success: function(uploadFile) {
	    	if (uploadFile) {
		    	$('#files').html('<div id="imgTemp"><a href="' + uploadFile.url + '" target="_blank">' + uploadFile.name + '</a>&nbsp;&nbsp;<a href="javascript:$(\'#imgTemp, #imgSrc\').remove()">[x]</a><br></div>');
		     	$('#files').append('<img id="imgSrc" class="img-responsive" src="' + uploadFile.url + '">');
